  ...
  return (
    <div>
        <Row className='flex  justify-around m-5 gap-5'>
          <Card className='font-outfit min-w-[200px]  flex-1 shadow-lg ' title="Current balance">
            <p>₹ {balance}</p>
          ...
          <Card className='font-outfit min-w-[200px]  flex-1 shadow-lg' title="Total Income">
            <p>₹ {income}</p>
          ...
          <Card className='font-outfit min-w-[200px]  flex-1 shadow-lg' title="Total Expenses">
            <p>₹ {expense}</p>
